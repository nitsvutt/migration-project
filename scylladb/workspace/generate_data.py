...
def main():
    ...
    generate_csv(f'{COMMON_PATH}/tmp/users.csv', num_rows, user_headers, user_data_func)
    ...
    generate_csv(f'{COMMON_PATH}/tmp/products.csv', num_rows, product_headers, product_data_func)
    ...
    generate_csv(f'{COMMON_PATH}/tmp/orders.csv', num_rows, order_headers, order_data_func)
